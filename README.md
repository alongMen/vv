...
基于 Vue + Element UI 的娇人美容院解决方案。[线上地址](https://lin-xin.gitee.io/example/work/)
...
该方案作为一套多功能的后台框架模板，适用于绝大部分的娇人美容院（Web Management System）开发。基于 vue.js，使用 vue-cli3 脚手架，引用 Element UI 组件库，方便开发快速简洁好看的组件。分离颜色样式，支持手动切换主题色，而且很方便使用自定义主题色。
